...
label marcos:
    ...
    if first_time:
        ...
        pause 1.0
        marcos "GGRGRGRGRGRGAFMAKGMFASKLGMSDALKFSDAMK."
...
label marcos_dialogue_menu:
    menu:
        ...
        "Ask for the gap in its work last night." if marcos_clue_computer_status == "investigated":
            ...
            jacob "You stopped working at 22:00."
            marcos "Oh yes."
        ...
        "Check law 1/359880/32 on Internet" if not hannah_ending and marcos_clue_computer_status == "investigated" and hannah_requires_dog_medal and "dog medal" not in inventory:
